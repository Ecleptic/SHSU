/**
   A MODIFIED class that implements the ADT list by using a chain of
   ...
   @version 4.0
*/
public class ModifiedLList<T>
{
	private Node firstNode;            // Reference to first node of chain
	private int  numberOfEntries; 

	public ModifiedLList()
	{
   ...
   // Segment 18.20
   public boolean containsR(T anEntry)   // Altered name for this demo
   {
