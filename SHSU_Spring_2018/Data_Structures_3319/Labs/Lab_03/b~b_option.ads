...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#fc089494#;
   ...
   u00042 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00042, "ada__streamsB");
   u00043 : constant Version_32 := 16#2e6701ab#;
   ...
   u00063 : constant Version_32 := 16#e2ea8656#;
   pragma Export (C, u00063, "ada__strings__mapsB");
   u00064 : constant Version_32 := 16#1e526bec#;
   pragma Export (C, u00064, "ada__strings__mapsS");
   u00065 : constant Version_32 := 16#a55efc94#;
   ...
   u00068 : constant Version_32 := 16#4b7bb96a#;
   pragma Export (C, u00068, "ada__characters__latin_1S");
   u00069 : constant Version_32 := 16#5b9edcc4#;
   pragma Export (C, u00069, "system__compare_array_unsigned_8B");
   u00070 : constant Version_32 := 16#b900707a#;
   pragma Export (C, u00070, "system__compare_array_unsigned_8S");
   u00071 : constant Version_32 := 16#5f72f755#;
   pragma Export (C, u00071, "system__address_operationsB");
   u00072 : constant Version_32 := 16#030fbfc4#;
   pragma Export (C, u00072, "system__address_operationsS");
   u00073 : constant Version_32 := 16#6a859064#;
   pragma Export (C, u00073, "system__storage_pools__subpoolsB");
   u00074 : constant Version_32 := 16#e3b008dc#;
   pragma Export (C, u00074, "system__storage_pools__subpoolsS");
   u00075 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00075, "system__address_imageB");
   u00076 : constant Version_32 := 16#b1ef9ccd#;
   pragma Export (C, u00076, "system__address_imageS");
   u00077 : constant Version_32 := 16#b5b2aca1#;
   pragma Export (C, u00077, "system__finalization_mastersB");
   u00078 : constant Version_32 := 16#641528b7#;
   pragma Export (C, u00078, "system__finalization_mastersS");
   u00079 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00079, "system__img_boolB");
   u00080 : constant Version_32 := 16#e5da701c#;
   pragma Export (C, u00080, "system__img_boolS");
   ...
   u00083 : constant Version_32 := 16#b7ab275c#;
   pragma Export (C, u00083, "ada__finalizationB");
   u00084 : constant Version_32 := 16#19f764ca#;
   ...
   u00111 : constant Version_32 := 16#8f637df8#;
   pragma Export (C, u00111, "ada__characters__handlingB");
   u00112 : constant Version_32 := 16#3b3f6154#;
   ...
   u00118 : constant Version_32 := 16#18d57884#;
   pragma Export (C, u00118, "system__img_biuB");
   u00119 : constant Version_32 := 16#4b792d7a#;
   pragma Export (C, u00119, "system__img_biuS");
   u00120 : constant Version_32 := 16#e7d8734f#;
   pragma Export (C, u00120, "system__img_llbB");
   u00121 : constant Version_32 := 16#0abe3d84#;
   pragma Export (C, u00121, "system__img_llbS");
   u00122 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00122, "system__img_lliB");
   u00123 : constant Version_32 := 16#014c5426#;
   pragma Export (C, u00123, "system__img_lliS");
   u00124 : constant Version_32 := 16#0e8808d4#;
   pragma Export (C, u00124, "system__img_llwB");
   u00125 : constant Version_32 := 16#a3d21e12#;
   pragma Export (C, u00125, "system__img_llwS");
   u00126 : constant Version_32 := 16#428b07f8#;
   pragma Export (C, u00126, "system__img_wiuB");
   u00127 : constant Version_32 := 16#2538aae8#;
   pragma Export (C, u00127, "system__img_wiuS");
   u00128 : constant Version_32 := 16#7ebd8839#;
   pragma Export (C, u00128, "system__val_intB");
   u00129 : constant Version_32 := 16#58a62bc8#;
   pragma Export (C, u00129, "system__val_intS");
   u00130 : constant Version_32 := 16#b44f9ae7#;
   pragma Export (C, u00130, "system__val_unsB");
   u00131 : constant Version_32 := 16#9df3480c#;
   pragma Export (C, u00131, "system__val_unsS");
   u00132 : constant Version_32 := 16#b3aa7b17#;
   pragma Export (C, u00132, "system__val_lliB");
   u00133 : constant Version_32 := 16#8a27e757#;
   pragma Export (C, u00133, "system__val_lliS");
   u00134 : constant Version_32 := 16#74c80ba7#;
   pragma Export (C, u00134, "compstkgB");
   u00135 : constant Version_32 := 16#7f04e6a5#;
   pragma Export (C, u00135, "compstkgS");
   u00136 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00136, "ada__integer_text_ioB");
   u00137 : constant Version_32 := 16#f1daf268#;
   ...
   u00139 : constant Version_32 := 16#12a3d627#;
   pragma Export (C, u00139, "system__concat_2S");
   u00140 : constant Version_32 := 16#d0432c8d#;
   pragma Export (C, u00140, "system__img_enum_newB");
   u00141 : constant Version_32 := 16#714f0737#;
   pragma Export (C, u00141, "system__img_enum_newS");
   u00142 : constant Version_32 := 16#4b37b589#;
   pragma Export (C, u00142, "system__val_enumB");
   u00143 : constant Version_32 := 16#ab194362#;
   pragma Export (C, u00143, "system__val_enumS");
   u00144 : constant Version_32 := 16#9d39c675#;
   pragma Export (C, u00144, "system__memoryB");
   u00145 : constant Version_32 := 16#497e67c3#;
